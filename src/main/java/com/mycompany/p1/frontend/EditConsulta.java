 ...
 * @author marin
 */
public class EditConsulta extends javax.swing.JFrame {
    ...
    public EditConsulta(MenuBack menu, int row) {
        ...
        for(Medico medico: menuB.listaDeMedicos) {
            jComboBox1.addItem(medico.getNomePessoal());
            jComboBox1.repaint();
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditConsulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

 ...
 * @author marin
 */
public class ListarEndereco extends javax.swing.JFrame {
    
    private ArrayList<Endereco> listaEndereco;
    /**
     * Creates new form ListarEndereco
     */
    public ListarEndereco(ArrayList<Endereco> lista) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarEndereco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarEndereco(lista).setVisible(true);
            }
        });
    }

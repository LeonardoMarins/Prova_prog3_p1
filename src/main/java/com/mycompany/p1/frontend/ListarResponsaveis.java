 ...
 * @author marin
 */
public class ListarResponsaveis extends javax.swing.JFrame {

    private ArrayList<Responsavel> listaResponsavel;
    
    
    public ListarResponsaveis(ArrayList<Responsavel> lista) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarResponsaveis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarResponsaveis(lista).setVisible(true);
            }
        });
    }
